...
public sealed record class PetCreateParams : ParamsBase
{
    ...
    public PetCreateParamsProperties::Status? Status
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<PetCreateParamsProperties::Status?>(element);
        }
    ...
    public List<PetCreateParamsProperties::Tag>? Tags
    {
        get
        {
            ...
            return JsonSerializer.Deserialize<List<PetCreateParamsProperties::Tag>?>(element);
        }
